...
mainkey = ReplyKeyboardMarkup(resize_keyboard = True)
mainbutton = KeyboardButton(text = "Расчет калорий по формуле Миффлина-Сан Жеора")
mainkey.add(mainbutton)
...
async def start_message(message):
    await message.answer("Привет! Я бот помогающий вашему здоровью.", reply_markup = mainkey)
